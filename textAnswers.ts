...
//
//
//Describe the runtime difference(s) between `for await (const a  of [p1, p2, p3]) { ... }` vs `[p1, p2, p3].forEach(async (p) {  await p })`
//
...
//
//Explain the difference between nodejs and V8
//
...
//
//Using typescript, what is the difference between an enum and an object?
//
...
//Write a typescript variable declaration for a variable `a` that  will guarantee that it is a property name or key of object `b`
//
type b = {
  name: string;
  age: number;
